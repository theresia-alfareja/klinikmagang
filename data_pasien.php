...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-6">
            <a href="Dashboard.php" class=" mb-5 text-white text-2xl font-semibold uppercase hover:text-gray-300">Magang Klinik</a>
        </div>
   ...
   ?>
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
            <div class="flex items-center justify-between">
                <a href="index.php" class="text-white text-3xl font-semibold uppercase hover:text-gray-300">Klinik Theresia</a>
...
<div class="w-full mt-2">
        <h1 class="text-3xl text-black pb-6" style="margin-bottom: -1%;">
              <i class="fas fa-list mr-3"></i>Data Pasien
        </h1>
        <div class="text-right mb-5">
            <a href="tambah_pasien.php" class="daftar px-5 py-2 text-white font-light tracking-wider bg-gray-900 rounded font-semibold" style="font-size: 3vh;">Daftar Pasien</a>
        </div>
                        ...
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Usia</th>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Jeis kelamin</th>
                                    ...
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">No Hp/WA</th>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">No.KTP</th>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Tanggal Daftar</th>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Riwayat</th>  
                                </tr>
                            </thead>
<?php
...
<td  class="px-5 py-5 bg-white text-sm"><?php echo $hasil['id_pasien'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['nama_pasien'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['tgl_lahir_pasien'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['usia'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['jenis_kelamin'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['pekerjaan'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['pembayaran'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['nomor_handphone'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['no_ktp'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['tgl_daftar'] ?></td>
<td  class="px-3 py-3"><a href="rekam_medis.php" class="daftar" style="text-decoration: underline;color: blue;">Rekam Medis</a></td>
</tr>
</tbody>
<?php
}
