...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="data_dokter.php" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
   ...
   ?>
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                ...
                <a href="data_dokter.php" class="flex items-center active-nav-link text-white py-2 pl-4 nav-item">
                    <i class="fas fa-user-nurse mr-3"></i>
                    Dokter
                </a> 
...
$insert =mysqli_query($conn, "INSERT INTO tb_dokter VALUES
 (
  '".$_POST['id_dokter']."',
  '".$_POST['nama_dokter']."',
  '".$_POST['nama_poli']."',  
 ...
 ?>
<?php 
    $data = mysqli_query($conn, "SELECT MAX(id_dokter) AS idok FROM
    tb_dokter");
    $data_akhir = mysqli_fetch_array($data);
    $id1 = $data_akhir['idok'];
    $id2 = substr($id1,3,2); //DR
    $id3 = $id2 + 1;
    $id4 = 'DR'.sprintf('%02s' , $id3);
?>
...
<div class="mt-6">
    <div class="w-full md:flex-shrink-0 leading-loose">
       <form class="p-10 bg-white rounded shadow-xl" action="" method="post">
            <div class="">
               <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" type="text" name="id_dokter" id="id_dokter" value="<?php echo $id4; ?>" readonly/>
            </div>
          <p class="text-lg text-gray-800 font-medium mb-1 mt-3">Nama Dokter</p>
            <div class="">
               <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" type="text" name="nama_dokter" id="nama_dokter">
            </div>          
          <p class="text-lg text-gray-800 font-medium mb-1 mt-3">Poli</p>
            <div class="">
               <select type="text" class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" name="nama_poli" placeholder="nama_poli" required>
          ...
          <p class="text-lg text-gray-800 font-medium mb-1 mt-3">Agama</p>
            <div class="">
               <select type="text" class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" name="agama" required>
                <option>Islam</option>
          ...
          <p class="text-lg text-gray-800 font-medium mb-1 mt-3">No Hp/WA</p>
            <div class="">
               <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" type="text" name="no_hp_dokter" id="no_hp_dokter">
            </div> 
          <p class="text-lg text-gray-800 font-medium mb-1 mt-3">Tanggal Lahir</p>
            <div class="">
               <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" type="date" name="tgl_lahir_dokter" id="tgl_lahir_dokter">
            </div>
          ...
          <p class="text-lg text-gray-800 font-medium mb-1 mt-3">Alamat</p>
            <div class="">
               <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" type="text" name="alamat_dokter" id="alamat_dokter">
            </div> 
          <p class="text-lg text-gray-800 font-medium mb-1 mt-3">Jadwal Praktek</p>
            <div class="">
               <textarea class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" name="jadwal_dokter" id="jadwal_dokter"></textarea>
            </div> 
            <br>
