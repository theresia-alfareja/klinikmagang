...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="data_poliklinik.php" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
   ...
   ?>
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                ...
                <a href="data_poliklinik.php" class="flex items-center active-nav-link text-white py-2 pl-4 nav-item">
                    <i class="fas fa-clinic-medical mr-3"></i>
                    Poliklinik
                </a>
...
$insert =mysqli_query($conn, "INSERT INTO tb_poliklinik VALUES
 (
  '".$_POST['id_poli']."',
  '".$_POST['nama_poli']."',
  '".$_POST['nama_ruang']."'
 ...
 ?>
<?php 
    $data = mysqli_query($conn, "SELECT MAX(id_poli) AS idpol FROM
    tb_poliklinik");
    $data_akhir = mysqli_fetch_array($data);
    $id1 = $data_akhir['idpol'];
    $id2 = substr($id1,3,2); //POL
    $id3 = $id2 + 1;
    $id4 = 'PK'.sprintf('%02s' , $id3);
?>
<div class="w-full mt-2">
        <h1 class="text-3xl text-black pb-6 mb-1">
              <i class="fas fa-list mr-3"></i>Tambah Poli
        </h1>          
</div>
<div class="mt-6">
    <div class="w-full md:flex-shrink-0 leading-loose">
       <form class="p-10 bg-white rounded shadow-xl" action="" method="post">
            <div class="">
               <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" type="text" name="id_poli" id="id_poli" value="<?php echo $id4; ?>" readonly/>
            </div>      
          <p class="text-lg text-gray-800 font-medium mb-1 mt-3">Nama Poli</p>
            <div class="">
               <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" type="text" name="nama_poli" id="nama_poli" required>
            </div>   
          <p class="text-lg text-gray-800 font-medium mb-1 mt-3">Nama Ruang</p>
            <div class="">
               <textarea class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" name="nama_ruang" id="nama_ruang" required></textarea>
            </div>  
            <br>
