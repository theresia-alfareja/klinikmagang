...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="data_user.php" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
   ...
   ?>
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                ...
                <a href="data_user.php" class="flex items-center active-nav-link text-white py-2 pl-4 nav-item">
                    <i class="fas fa-users mr-3"></i>
                    Data User
                </a>
...
<a href="level_user.php" class="hakakses p-2 mr-2S hover:text-white" style="border:3px solid #2E9AFE;border-radius: 10px;">
    Hak Akses
</a>
<a href="register.php" class="akun p-2 ml-2 hover:text-white" style="border:3px solid #00BFFF;border-radius: 10px;">
    Daftar Akun
</a>
</div>
<br><br>
                    <div class="bg-white overflow-auto mt-1">
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    <th class="text-center text-left py-3 px-4 uppercase font-semibold text-sm">No</th>
                                    ...
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Level user</th>
...
<td  class="px-5 py-5 bg-white text-sm"><?php echo $no++ ?></td>
<td  class="px-3 py-3"><?php echo $hasil['username'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['nama_lengkap_user'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['level_user'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['alamat_user'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['nomor_telepon_user'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['password'] ?></td>
