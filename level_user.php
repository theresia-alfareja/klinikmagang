...
<div class="w-full mt-2">
        <h1 class="text-3xl text-black">
              <i class="fas fa-list mr-3"></i>Hak akses user
        </h1>
        <br>
                        ...
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Hak Akses</th>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Keterangan</th>
                                </tr>
                            </thead>
<?php
$query = mysqli_query($conn, "SELECT * FROM tb_level_user");
$no = 1;
...
<td  class="px-3 py-3"><?php echo $hasil['keterangan'] ?></td>
</tr>
</tbody>
<?php
}
