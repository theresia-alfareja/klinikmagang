...
<div class="w-full mt-2">
        ...
        <h1 class="text-3xl text-black pb-6" style="margin-bottom: -1%;">
              <i class="fas fa-list mr-3"></i>Data Tindakan
        </h1>
        <div class="text-right mb-5">
            <a href="tambah_tindakan.php" class="daftar px-5 py-2 text-white font-light tracking-wider bg-gray-900 rounded font-semibold" style="font-size: 3vh;">Tambah</a>
        </div>
                        ...
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Nama Tindakan</th>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Harga</th>
                                </tr>
                            </thead>
<?php
error_reporting(0);
$query = mysqli_query($conn, "SELECT * FROM tb_tindakan");
...
<td  class="px-5 py-3"><?php echo $hasil['id_tindakan'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['nama_tindakan'] ?></td>
<td  class="px-3 py-3"><?php echo $hasil['harga_tindakan'] ?></td>
</tr>
</tbody>
<?php
}
